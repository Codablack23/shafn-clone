  ...
  return (
    <div>
      <div className="ps__cookie-popup" id="cookie-popup">
        ...
        <p>
          We use cookies to operate this website improve usability and keep
          track of your products to personalize your experience,
        </p>
        <button className="accept" onClick={() => CreateCookie("accepted")}>
          Accept all cookies
        </button>
