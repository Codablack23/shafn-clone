...
export default function Nav() {
    return (
        <>
            <nav className="max-w-[1196px] z-[100] gap-x-[24px] px-[16px] top-0 py-4 hidden lg:flex justify-between sticky mx-auto">
            ...
            <nav className="lg:hidden sticky z-[100] p-4 flex items-center">
                {/* <div className="h-[50px]  rounded-full w-[50px] flex items-center justify-center">
                    <img src="/static/img/favi.png" className="h-[50px] w-[50px]" alt="" />
                </div> */}
               <div className="flex-1">
                 <div className="bg-white w-10/12 gap-x-4 justify-center mx-auto h-[36px] flex px-4 items-center rounded-[30px]">
