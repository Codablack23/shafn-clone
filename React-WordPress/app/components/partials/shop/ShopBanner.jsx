        ...
        <div className="ps-shop-banner">
            <Splide aria-label="My Favorite Images" options={sliderOptions}>
                <SplideSlide>
                    ...
                    <p className="absolute cursor-pointer bottom-0 ml-80 mb-80 py-10 px-12 text-white font-bold text-4xl bg-[#50B2D0] shadow-xl shadow-[#3b5e69] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 ml-80 mb-80 py-10 px-12 text-white font-bold text-4xl bg-[#544679] shadow-xl shadow-[#1f1822] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 ml-80 mb-80 py-10 px-12 text-white font-bold text-4xl bg-[#C99C48] shadow-xl shadow-[#211716] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 ml-80 mb-80 py-10 px-12 text-white font-bold text-4xl bg-[#4C9977] shadow-xl shadow-[#222c24] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 ml-80 mb-80 py-10 px-12 text-white font-bold text-4xl bg-[#D67777] shadow-xl shadow-[#443032] rounded-3xl" >Shop Now</p>
