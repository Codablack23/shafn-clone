        ...
        <div className="ps-shop-banner">
            <Splide aria-label="My Favorite Images" options={sliderOptions}>
                <SplideSlide>
                    ...
                    <p className="absolute cursor-pointer bottom-0 md:ml-80 md:mb-64 mb-32 ml-10 md:py-[48px] py-3 md:px-12 px-7 text-white font-bold md:text-4xl text-[20px] bg-[#50B2D0] shadow-xl shadow-[#3b5e69] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 md:ml-80 md:mb-64 mb-32 ml-10 md:py-[48px] py-3 md:px-12 px-7 text-white font-bold md:text-4xl text-[20px] bg-[#544679] shadow-xl shadow-[#1f1822] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 md:ml-80 md:mb-64 mb-32 ml-10 md:py-[48px] py-3 md:px-12 px-7 text-white font-bold md:text-4xl text-[20px] bg-[#C99C48] shadow-xl shadow-[#211716] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 md:ml-80 md:mb-64 mb-32 ml-10 md:py-[48px] py-3 md:px-12 px-7 text-white font-bold md:text-4xl text-[20px] bg-[#4C9977] shadow-xl shadow-[#222c24] rounded-3xl" >Shop Now</p>
                ...
                <SplideSlide>
                    <div style={{height:"500px"}}>
                    <p className="absolute cursor-pointer bottom-0 md:ml-80 md:mb-64 mb-32 ml-10 md:py-[48px] py-3 md:px-12 px-7 text-white font-bold md:text-4xl text-[20px] bg-[#D67777] shadow-xl shadow-[#443032] rounded-3xl" >Shop Now</p>
