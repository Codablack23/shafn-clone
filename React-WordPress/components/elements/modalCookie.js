        ...
        return(
           <div>
             <div className="ps__cookie-popup" id="cookie-popup">
                <span className="close" onClick={HideCookiePolicy}><i className="bi bi-x-lg"></i></span>
                <h4 className="title">This website uses cookies</h4>
                <p>We use cookies to operate this website improve usability and personalize your experience, feel free to make a choice to accept or reject.</p>
                <button className="accept" onClick={()=>CreateCookie("accepted")}>Accept all cookies</button>
                <button className="reject" onClick={()=>CreateCookie("rejected")}>Reject all cookies</button>
            </div>
